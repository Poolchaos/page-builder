...
/*
*/
import {ScanFingerprintService} from './scanfingerprint.service';
import {ScanFingerprintStore} from './scanfingerprint.store';
...
/*
*/
@inject(Router, ScanFingerprintService, ScanFingerprintStore, ViewConversationService, ViewConversationStore, ConversationStore)
export class ScanFingerprint {
  
  disabled = false;

  constructor(router, scanFingerprintService, scanFingerprintStore, viewConversationService, viewConversationStore, conversationStore) {
