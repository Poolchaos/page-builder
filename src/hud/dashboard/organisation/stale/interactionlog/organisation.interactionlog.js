...
zailab
*/
import {CallHistoryDialog} from './organisation.interactionlog.dialog';
import {CallHistorySearchDialog} from './organisation.interactionlog.search.dialog';
import {DialogService} from 'aurelia-dialog';
import {CallHistoryStore} from './organisation.interactionlog.store';
import {AgentCallHistoryService} from './organisation.interactionlog.service';
import {UserSession} from 'zailab.framework';
import {HUD_ANIMATOR_EVENTS}  from '../../../hud.animator.events';
import {searchParams} from './organisation.interactionlog.store';
