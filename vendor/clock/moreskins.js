CoolClock.config.skins = {
	...
	aiva: {
		outerBorder:      { lineWidth: 190, radius: 4, color: "#ffffff", alpha: 1 },
		smallIndicator:   { lineWidth: 20, startAt: 90, endAt: 96, color: "#ffffff", alpha: 0 },
		largeIndicator:   { lineWidth: 20, startAt: 90, endAt: 98, color: "#ffffff", alpha: 0 },
		hourHand:         { lineWidth: 8, startAt: 20, endAt: 60, color: "#2086c4", alpha: 1 },
		minuteHand:       { lineWidth: 4, startAt: 20, endAt: 80, color: "#2086c4", alpha: 1 },
		secondHand:       { lineWidth: 8, startAt: 84, endAt: 92, color: "#2086c4", alpha: 1 },
		secondDecoration: { lineWidth: 2, startAt: 0, radius: 4, fillColor: "#ffffff", color: "black", alpha: 1 }
	},
	swissRail: {
	...
	Cold: {
		...
		secondDecoration: { lineWidth: 5, startAt: 30, radius: 50, fillColor: "black", color: "black", alpha: 1 }
	},
